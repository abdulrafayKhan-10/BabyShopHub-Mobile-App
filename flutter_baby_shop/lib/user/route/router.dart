...
import 'package:shop/user/entry_point.dart';
import 'package:shop/user/route/route_constants.dart';
import 'package:shop/user/screens/address/views/addresses_screen.dart';
import 'package:shop/user/screens/auth/views/login_screen.dart';
import 'package:shop/user/screens/auth/views/password_recovery_screen.dart';
import 'package:shop/user/screens/auth/views/signup_screen.dart';
import 'package:shop/user/screens/bookmark/views/bookmark_screen.dart';
import 'package:shop/user/screens/checkout/views/cart_screen.dart';
import 'package:shop/user/screens/discover/views/discover_screen.dart';
import 'package:shop/user/screens/home/views/home_screen.dart';
import 'package:shop/user/screens/kids/views/kids_screen.dart';
import 'package:shop/user/screens/notification/view/enable_notification_screen.dart';
import 'package:shop/user/screens/notification/view/no_notification_screen.dart';
import 'package:shop/user/screens/notification/view/notification_ontions_screen.dart';
import 'package:shop/user/screens/notification/view/notificatios_screen.dart';
import 'package:shop/user/screens/onbording/views/onbording_screnn.dart';
import 'package:shop/user/screens/order/views/orders_screen.dart';
import 'package:shop/user/screens/product/views/product_details_screen.dart';
import 'package:shop/user/screens/profile/views/profile_screen.dart';
import 'package:shop/user/screens/reviews/view/product_reviews_screen.dart';
import 'package:shop/user/screens/search/views/search_screen.dart';
import 'package:shop/user/screens/user_info/views/user_info_screen.dart';
import 'package:shop/user/screens/wallet/views/empty_wallet_screen.dart';
import 'package:shop/user/screens/wallet/views/wallet_screen.dart';
